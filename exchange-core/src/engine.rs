...
/// An interface for dealing with engine.
///
/// This is the core trait for matching engine implementation.
pub trait Engine: Tree {
    type Algo: Algo;
...
pub trait Tree {
    ...
    ///
    /// This method is inteded to be used at `Engine::matching` internals.
